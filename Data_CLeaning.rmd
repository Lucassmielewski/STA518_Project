...
game_df <- game_df %>% 
  mutate(`First` = case_when(   
         ...
         `Runs` = case_when((str_detect(`Runner Advancements`, "-H") | 
                            str_detect(`Runner Advancements1`, "-H") |
                            str_detect(`Runner Advancements2`, "-H") |
                            str_detect(`Runner Advancements3`, "-H")) ~ 
                            
                            (as.numeric(str_count(`Runner Advancements`,"-H")) +
                            as.numeric(str_count(`Runner Advancements1`,"-H")) + 
                            as.numeric(str_count(`Runner Advancements2`,"-H")) +
                            as.numeric(str_count(`Runner Advancements3`,"-H"))),
...
Moving Runners is fixed, Need to finish Runs
